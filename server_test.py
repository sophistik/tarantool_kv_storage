...
class TestPOSTMethod(unittest.TestCase):
    ...
    def test_POST_200(self):
        ...
        url = 'http://37.46.132.97/kv/president/'
        requests.delete(url)
...
class TestGETMethod(unittest.TestCase):
    ...
    def test_GET_200(self):
        ...
        url = 'http://37.46.132.97/kv/money/'
    ...
    def test_GET_404(self):
        url = 'http://37.46.132.97/kv/ukrainian_crimea/'
        response = requests.get(url)
        self.assertEqual(str(response), '<Response [404]>')
...
class TestDELETEMethod(unittest.TestCase):
    ...
    def test_DELETE_200(self):
        ...
        url = 'http://37.46.132.97/kv/opposite/'
        response = requests.delete(url)
        self.assertEqual(str(response), '<Response [200]>')

    def test_GET_NOT_FOUND(self):
        url = 'http://37.46.132.97/kv/putin/'
        response = requests.delete(url)
        self.assertEqual(str(response), '<Response [404]>')
